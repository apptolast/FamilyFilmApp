...
import familyfilmkmp.composeapp.generated.resources.group_dialog_name_empty_error_message
            ...
            OutlinedTextField(
                ...
                supportingText = {
                    if (groupName.isBlank()) {
                        SupportingErrorText(stringResource(Res.string.group_dialog_name_empty_error_message))
                    }
                },
            )
        },
