            ...
            Row(
                ...
                if (isOwner) {
                    TooltipBox(
                        ...
                        tooltip = {
                            PlainTooltip {
                                Text(stringResource(Res.string.groups_tooltip_edit_name))
                            }
                        },
                    ...
                    TooltipBox(
                        ...
                        tooltip = {
                            PlainTooltip {
                                Text(stringResource(Res.string.groups_tooltip_add_member))
                            }
                        },
                        state = rememberTooltipState(),
                    ) {
                    ...
                    TooltipBox(
                        ...
                        tooltip = {
                            PlainTooltip {
                                Text(stringResource(Res.string.groups_tooltip_delete_group))
                            }
                        },
                        state = rememberTooltipState(),
                    ) {
...
@Preview
@Composable
private fun PreviewGroupCardOwner() {
    FamilyFilmAppTheme {
        GroupCard(
...
@Preview
@Composable
private fun PreviewGroupCardNotOwner() {
    FamilyFilmAppTheme {
        GroupCard(
