...
import familyfilmkmp.composeapp.generated.resources.username_prompt_description
import familyfilmkmp.composeapp.generated.resources.username_prompt_skip
import familyfilmkmp.composeapp.generated.resources.username_prompt_title
...
fun UsernameSetupDialog(
    ...
    AlertDialog(
        ...
        modifier = modifier,
        title = { Text(text = stringResource(Res.string.username_prompt_title)) },
        text = {
            Column {
                Text(
                    text = stringResource(Res.string.username_prompt_description),
        ...
        dismissButton = {
            TextButton(onClick = onSkip) {
                Text(text = stringResource(Res.string.username_prompt_skip))
            }
        },
    )
}
