...
import familyfilmkmp.composeapp.generated.resources.region_search_hint
import familyfilmkmp.composeapp.generated.resources.region_select_title
...
fun CountryPickerDialog(
    ...
    val sortedRegions = TMDB_REGIONS.sortedBy { region ->
        getCountryDisplayName(region.countryCode)
    }
    ...
    val filteredRegions = if (searchQuery.isBlank()) {
        ...
        sortedRegions.filter { region ->
            val displayName = getCountryDisplayName(region.countryCode)
    ...
    AlertDialog(
        ...
        title = {
            Text(stringResource(Res.string.region_select_title))
        },
        text = {
            Column {
                OutlinedTextField(
